        ...
        <div className="overflow-y-auto fixed inset-0 z-50 ">
          ...
          <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div className="my-4 transition-opacity sm:my-0 fixed inset-0" aria-hidden="true">
              <div
                className="inline-block transform overflow-hidden rounded-sm border sm:my-8 sm:max-w-lg border-neutral-700 backgroundSlateCustom px-8 pt-5 pb-4 text-left align-bottom transition-all sm:w-full sm:py-6 sm:align-middle"
                role="dialog"
                aria-modal="true"
                ...
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    <h3 className="text-2xl font-semibold leading-6 text-white" id="modal-headline">
                ...
                <div className="mt-5 flex border-b pt-2 pb-4 text-center border-gray-900 sm:mt-0 sm:pt-4">
                  <span className="flex self-center font-medium ltr:mr-2 rtl:ml-2 text-gray-50">
                    Add to calendar
                  </span>
