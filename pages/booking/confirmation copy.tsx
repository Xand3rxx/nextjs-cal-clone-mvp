const Confirmation = () => {
  return (
    <section className="h-screen backgroundSlateCustom">
      <main className="mx-auto max-w-3xl py-24 rounded-sm border-color-custom backgroundSlateCustom">
              ...
              <div
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="border-bookinglightest text-bookingdark mt-4 grid grid-cols-3 border-t border-b py-4 text-left dark:border-gray-900 dark:text-gray-300">
                      ...
                      <div className="col-span-2">
                        ...
                        <br />
                        10:30 - 30 mins <span className="text-bookinglight">(Africa/Lagos)</span>
                      </div>
                ...
                <div className="border-bookinglightest mt-5 flex border-b pt-2 pb-4 text-center dark:border-gray-900 sm:mt-0 sm:pt-4">
                  ...
                  <div className="flex flex-grow justify-center text-center">
                    ...
                    <a
                      className="mx-2 h-10 w-10 rounded-sm border border-neutral-200 px-3 py-2 dark:border-neutral-700 dark:text-white"
                      download="Quick Chat.ics"
                      href="data:text/calendar,BEGIN%3AVCALENDAR%0D%0AVERSION%3A2.0%0D%0ACALSCALE%3AGREGORIAN%0D%0APRODID%3Aadamgibbons%2Fics%0D%0AMETHOD%3APUBLISH%0D%0AX-PUBLISHED-TTL%3APT1H%0D%0ABEGIN%3AVEVENT%0D%0AUID%3AKb9nU0HOki1q6_oJQ3_2H%0D%0ASUMMARY%3AQuick%20Chat%20between%20Anthony%20Joboy%20and%20Dummy%20Form%0D%0ADTSTAMP%3A20220420T093700Z%0D%0ADTSTART%3A20220421T093000Z%0D%0ADESCRIPTION%3AA%20quick%20video%20meeting%0D%0ALOCATION%3AWeb%20conferencing%20details%20to%20follow%20in%20the%20confirmation%20email.%0D%0ADURATION%3APT30M%0D%0AEND%3AVEVENT%0D%0AEND%3AVCALENDAR%0D%0A">
                      <svg
                        version="1.1"
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="border-bookinglightest text-booking-lighter pt-4 text-center text-xs dark:border-gray-900 dark:text-white">
                  ...
                  <form className="mt-4 flex">
                    <input
                      ...
                      name="email"
                      id="email"
                      className="rounded-sm border border-gray-300 py-2 px-3 focus:border-neutral-800 focus:outline-none focus:ring-1 focus:border-brand border-bookinglightest mt-0 block w-full shadow-sm focus:ring-black dark:border-gray-900 dark:bg-black dark:text-white sm:text-sm"
